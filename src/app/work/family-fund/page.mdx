import logo from '@/images/clients/Police Report AI BLACK.svg'
import imageHero from './hero.jpg'
import imageDebraFiscal from './debra-fiscal.jpg'

export const caseStudy = {
  client: 'Police Report',
  title: 'Innovative SaaS for Real Estate Foreclosures',
  description:
    'We developed a cutting-edge SaaS platform for managing real estate foreclosures using web scraping and advanced data analytics. ',
  summary: [
    'Hired by a client, we developed a cutting-edge SaaS platform for managing real estate foreclosures. Using web scraping and advanced data analytics, the platform streamlines property tracking and management. We also optimized it for search engine visibility, ensuring it ranks higher for keywords like “foreclosure management” and “real estate SaaS.',
  ],
  logo,
  image: { src: imageHero },
  date: '2024-12',
