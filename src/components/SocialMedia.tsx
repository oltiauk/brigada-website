...
export const socialMediaProfiles = [
  { title: 'Linkedin', href: 'https://www.linkedin.com/company/brigada-dev?trk=public_post_feed-actor-name', icon: LinkedinIcon },
  { title: 'Instagram', href: 'https://www.instagram.com/brigada.dev/', icon: InstagramIcon },
]
